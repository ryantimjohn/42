...
/*   Updated: 2018/03/18 16:29:47 by amyburgh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rush04_loop(int middlewidth, int middleheight)
{
...
void	rush(int x, int y)
{
	...
	else if (y == 1)
	{
		...
		rush04_loop(middlewidth, middleheight);
}
