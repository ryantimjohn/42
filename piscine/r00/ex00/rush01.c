...
/*   Updated: 2018/03/18 16:29:02 by amyburgh         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rush01_loop(int middlewidth, int middleheight)
{
...
void	rush(int x, int y)
{
	...
	else if (y == 1)
	{
		...
		rush01_loop(middlewidth, middleheight);
}
